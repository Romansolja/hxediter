...
// Hex grid spacing — multiples of char width.
constexpr float kGapByteMul     = 0.7f;
constexpr float kGapQuadMul     = 0.7f;   // every 4 bytes
constexpr float kGapOctetMul    = 1.2f;   // every 8 bytes
...
constexpr float kStatusGroupGap = 14.0f;
constexpr float kStatusInGroup  = 6.0f;
constexpr float kStatusGutter   = 8.0f;  // min gap before right-anchored metric
